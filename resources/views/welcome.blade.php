    ...
    <div x-data="{ open: false }" class="min-h-screen">
        ...
        <header class="bg-white shadow-lg sticky top-0 z-50">
                ...
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center">
                        ...
                        <nav class="hidden md:ml-6 md:flex space-x-4">
                            <a href="#"
                                class="px-3 py-2 text-sm font-medium text-gray-900 hover:text-lime-600">Inicio</a>
                            <a href="#"
                                class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-lime-600">Nosotros</a>
                            <a href="#"
                                class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-lime-600">Programas</a>
                            <a href="#"
                                class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-lime-600">Galería</a>
                            <a href="#"
                                class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-lime-600">Contacto</a>
                        </nav>
                    </div>
            ...
            <div x-show="open" class="md:hidden bg-white border-t border-gray-200">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <a href="#"
                        class="block px-3 py-2 text-base font-medium text-gray-900 hover:text-lime-600">Inicio</a>
                    <a href="#"
                        class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-lime-600">Nosotros</a>

                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('radio')" :active="request()->routeIs('radio')">
                            {{ __('Radio') }}
                        </x-nav-link>
                    </div>
                    <a href="#"
                        class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-lime-600">Galería</a>
                    <a href="#"
                        class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-lime-600">Contacto</a>
                    <a href="#"
                        class="block px-3 py-2 text-base font-medium text-white btn-primary mt-2 text-center">Portal
                        Estudiantes</a>
                </div>
            </div>
        </header>
        ...
        <main class="py-12 hero-pattern">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-16">
                ...
                @include('partials.radio_banner')

                <!-- Sección Principal (Héroe) Mejorada -->
                <div
                    class="bg-white rounded-2xl shadow-xl overflow-hidden md:flex flex-col lg:flex-row items-center p-8 card-hover">
                    <div class="lg:w-1/2 p-6">
                        <div
                            class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-lime-100 text-lime-700 mb-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="#"
                                class="inline-flex items-center justify-center px-6 py-3 text-white font-semibold rounded-full btn-primary">
                                <i class="fas fa-book-open mr-2"></i> Conoce más
                            </a>
                            <a href="#"
                                class="inline-flex items-center justify-center px-6 py-3 border border-lime-300 text-lime-600 font-semibold rounded-full hover:bg-lime-50 transition">
                    ...
                    <div class="lg:w-1/2 mt-6 lg:mt-0 p-6">
                        <div class="relative rounded-2xl overflow-hidden shadow-lg">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent rounded-2xl">
                            </div>
                ...
                <div x-data="{ currentSlide: 0, slides: 3 }" class="bg-white rounded-2xl shadow-xl p-8 card-hover">
                    <h2 class="text-3xl font-bold text-gray-900 text-center mb-2">Noticias y <span
                            class="text-lime-600">Eventos</span></h2>
                    <p class="text-gray-600 text-center mb-8">Mantente informado sobre las últimas novedades de nuestra
                        escuela</p>
                    ...
                    <div class="relative overflow-hidden rounded-xl">
                        <div class="flex transition-transform duration-500 ease-in-out"
                            ...
                            <div class="w-full flex-shrink-0">
                                <div class="md:flex items-stretch bg-lime-50 rounded-xl overflow-hidden">
                                    ...
                                    <div class="md:w-2/3 p-6">
                                        <span
                                            class="inline-block px-3 py-1 bg-lime-100 text-lime-700 rounded-full text-sm font-medium mb-4">Evento</span>
                                        <h3 class="text-2xl font-bold text-gray-900 mb-3">Feria de Ciencias 2023</h3>
                                        <p class="text-gray-700 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit. Nullam at mauris vel dolor tempor venenatis. Proin efficitur justo nec
                                            finibus malesuada. Nulla facilisi.</p>
                                        ...
                                        <a href="#"
                                            class="inline-flex items-center mt-4 text-lime-600 font-medium hover:text-lime-700">
                            ...
                            <div class="w-full flex-shrink-0">
                                <div class="md:flex items-stretch bg-lime-50 rounded-xl overflow-hidden">
                                    ...
                                    <div class="md:w-2/3 p-6">
                                        <span
                                            class="inline-block px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4">Noticia</span>
                                        <h3 class="text-2xl font-bold text-gray-900 mb-3">Nuevo Laboratorio de
                                            Computación</h3>
                                        <p class="text-gray-700 mb-4">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Nullam at mauris vel dolor tempor venenatis. Proin
                                            efficitur justo nec finibus malesuada. Nulla facilisi.</p>
                                        <div class="flex items-center text-gray-600">
                                            <i class="far fa-calendar-alt mr-2 text-lime-600"></i>
                            ...
                            <div class="w-full flex-shrink-0">
                                <div class="md:flex items-stretch bg-lime-50 rounded-xl overflow-hidden">
                                    ...
                                    <div class="md:w-2/3 p-6">
                                        <span
                                            class="inline-block px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-sm font-medium mb-4">Logro</span>
                                        <h3 class="text-2xl font-bold text-gray-900 mb-3">Ganadores del Concurso
                                            Regional</h3>
                                        <p class="text-gray-700 mb-4">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Nullam at mauris vel dolor tempor venenatis. Proin
                                            efficitur justo nec finibus malesuada. Nulla facilisi.</p>
                        ...
                        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                            <template x-for="i in slides">
                                <button @click="currentSlide = i - 1" class="w-3 h-3 rounded-full"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="bg-white p-8 rounded-2xl shadow-xl card-hover">
                        <div
                            class="inline-flex items-center justify-center w-16 h-16 bg-lime-100 text-lime-600 rounded-2xl mb-6">
                        ...
                        <p class="text-gray-600">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at mauris vel dolor tempor
                            venenatis.
                            Proin efficitur justo nec finibus malesuada. Nulla facilisi. Phasellus vehicula nisi eu nunc
                            aliquam,
                ...
                <div x-data="{ activeCategory: 'todas', categories: ['todas', 'actividades', 'deportes', 'naturaleza'] }" class="bg-white rounded-2xl shadow-xl p-8 card-hover">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                        <div>
                            <h2 class="text-3xl font-bold text-gray-900">Galería de <span
                                    class="text-lime-600">Fotos</span></h2>
                    ...
                    <div class="text-center mt-8">
                        <a href="#"
                            class="inline-flex items-center px-5 py-3 border border-lime-300 text-lime-600 font-medium rounded-full hover:bg-lime-50 transition">
                ...
                <div x-data="{ testimonialSlide: 0, testimonialSlides: 3 }" class="bg-lime-50 rounded-2xl shadow-xl p-8 card-hover">
                    <h2 class="text-3xl font-bold text-gray-900 text-center mb-2">Lo que dicen <span
                            class="text-lime-600">nuestras familias</span></h2>
                    ...
                    <div class="relative overflow-hidden rounded-xl">
                            ...
                            <div class="w-full flex-shrink-0 px-4">
                                <div class="bg-white p-8 rounded-2xl shadow-md">
                                    ...
                                    <p class="text-gray-700 italic">
                                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at mauris vel
                                        dolor tempor venenatis.
                                        Proin efficitur justo nec finibus malesuada. Nulla facilisi. Phasellus vehicula
                                        nisi eu nunc aliquam."
                                    </p>
                                    <div class="flex mt-4">
                        ...
                        <!-- Controles del carrusel -->
                        <button
                            @click="testimonialSlide = (testimonialSlide - 1 + testimonialSlides) % testimonialSlides"
                            class="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/80 text-lime-600 p-2 rounded-full shadow-md hover:bg-white">
                            <i class="fas fa-chevron-left"></i>
                        </button>
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden card-hover">
                    <div class="md:flex items-stretch">
                        <div class="md:w-1/2 p-8">
                            <h2 class="text-3xl font-bold text-gray-900 mb-4">Conoce Nuestra <span
                                    class="text-lime-600">Historia</span></h2>
                            <p class="text-gray-700 mb-6">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at mauris vel dolor
                                tempor venenatis.
                                Proin efficitur justo nec finibus malesuada. Nulla facilisi. Phasellus vehicula nisi eu
                                nunc aliquam,
                                sit amet convallis nisi tincidunt.
                            </p>
                            ...
                            <a href="#"
                                class="inline-flex items-center px-5 py-3 text-white font-medium rounded-full btn-primary">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 card-hover">
                    <h2 class="text-3xl font-bold text-gray-900 text-center mb-2">Ubicación y <span
                            class="text-lime-600">Contacto</span></h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        <div class="text-center p-6 bg-lime-50 rounded-2xl">
                            <div
                                class="inline-flex items-center justify-center w-14 h-14 bg-lime-100 text-lime-600 rounded-2xl mb-4">
                    ...
                    <div class="bg-gray-50 p-6 rounded-2xl">
                        ...
                        <form class="space-y-4">
                            ...
                            <div>
                                <label for="message"
                                    class="block text-sm font-medium text-gray-700 mb-1">Mensaje</label>
                                <textarea id="message" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-lime-500 focus:border-lime-500"></textarea>
                            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    <div>
                        ...
                        <p class="text-gray-400 mb-4">Educación de calidad en un entorno natural para formar a los
                            líderes del mañana.</p>
                        <div class="flex space-x-4">
                            <a href="#" class="text-gray-400 hover:text-lime-400"><i
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="#" class="text-gray-400 hover:text-white">Actividades
